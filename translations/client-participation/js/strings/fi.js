...
s.helpWhatAreGroupsDetail = "<p>Olet luultavasti nähnyt 'suositeltuja tuotteita' Amazonissa tai 'suositeltuja elokuvia' Netflixissä. Nämä palvelut käyttävät tilastoja ryhmitelläkseen käyttäjän sellaisten ihmisten kanssa, jotka ostavat ja katsovat samankaltaisia asioita, ja näyttää heille sitten asioita, joita nämä ihmiset ostivat tai katsoivat.</p> <p> Kun käyttäjä äänestää kannanotoista, hänet ryhmitellään sellaisten ihmisten kanssa, jotka äänestivät kuten hän! Voit nähdä nämä ryhmät alla. Kukin koostuu ihmisistä, joilla on samanlaisia mielipiteitä. Jokaisessa keskustelussa on löydettävissä kiehtovia oivalluksia. Klikkaa ryhmää nähdäksesi, mikä on saanut heidät yhteen ja mikä tekee heistä ainutlaatuisia! </p>";
